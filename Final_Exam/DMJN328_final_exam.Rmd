...
8. In words, what is the general relationship between sample size and standard error? 

9. What is a 95% confidence interval (or margin of error)? What happens to a confidence interval (or margin of error) as the sample size increases?
